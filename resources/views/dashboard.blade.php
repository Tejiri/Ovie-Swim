            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="{{ url('/') }}">
                            <span>Ovie Swims</span>
                        </a></div>

                    @if (Auth::user()->role == 'admin' || Auth::user()->role == 'coach')
                        <li><a href="{{ url('manage-squads') }}"><i class="ti-calendar"></i> Squad Management </a></li>
                    @else
                    @endif
                    @if (Auth::user()->role == 'admin')
                        <li><a href="{{ url('register-user') }}"><i class="ti-calendar"></i> Register User </a></li>
                    @elseif(Auth::user()->role == 'parent')
                        <li><a href="{{ url('register-user') }}"><i class="ti-calendar"></i> Register Child </a></li>
                    @endif

                    @if (Auth::user()->role == 'admin' || Auth::user()->role == 'coach')
                        <li><a href="{{ url('upload-result') }}"><i class="ti-calendar"></i> Upload Result </a></li>
                    @endif
                    <li><a href="{{ url('view-results') }}"><i class="ti-calendar"></i> View Results </a></li>
                    <li><a href="{{ url('update-profile') }}"><i class="ti-calendar"></i> Update Profile </a></li>

                    @if (Auth::user()->role == 'parent')
                        <li><a href="{{ url('manage-kids') }}"><i class="ti-calendar"></i> Manage Children Account</a>
                        </li>
                    @endif
                    ...
                    {{-- <li>
                        <a>
                            <form action="logout" method="post">
                                @csrf
                                <i class="ti-close"></i> <input type="submit" value="logout">
                            </form>
                        </a>
                    </li> --}}
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown dib">
                            <div class="header-icon">
                                <span
                                    class="user-avatar">{{ auth()->user()->firstName . ' ' . auth()->user()->lastName . ' (' . auth()->user()->username . ' - ' . auth()->user()->role . ')' }}
                                </span>
                        ...
                        {{-- <div class="dropdown dib">
                            <div class="header-icon" >
                                <a href="logout"> <i class="ti-close fa-1x"></i></a>
